...
//
//                       Project is Open-Source uses:  one Developement board, Wemos D1 R2, one RTC, DS3231 and one Barometric Pressure sensor, BME280;
...
#define SEALEVELPRESSURE_HPA (1013.25)   //generic value suggested by Adafruit
          ...
          if (client)
          {
               ...
               if(parsed)
               {
                    ...
                    if (strcmp(action, "GET") == 0)
                    {
                         ...
                         accessLog();   //logged, log-on details for "GET" HTTP request
                    ...
                    else
                    {
                         ...
                         accessLog();   //logged, log-on details for "Method Not Allowed," HTTP request
